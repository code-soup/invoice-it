...
<h2 class="csip-invoice-title">
	<span class="csip-invoice-title-text"><?php _e( 'INVOICE', PLUGIN_TEXT_DOMAIN ); ?></span>
	<span class="csip-invoice-title-code"><?php echo $invoice_code; ?></span>
</h2>

<ul class="csip-invoice-list">
	<li class="csip-invoice-list-label"><?php _e( 'date', PLUGIN_TEXT_DOMAIN ); ?></li>
	<li class="csip-invoice-list-entry"><?php echo $invoice_date; ?></li>
	<li class="csip-invoice-list-label"><?php _e( 'due', PLUGIN_TEXT_DOMAIN ); ?></li>
